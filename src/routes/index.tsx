  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Ouk Chatrang — Ancient Khmer Chess" },
      {
        ...
        content: "Learn and play the royal Khmer chess of Angkor with Hanuman as your guide.",
      },
    ],
  }),
  component: Welcome,
    ...
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-lg flex-1 flex-col px-5 pb-8 pt-6">
        ...
        <div className="relative mx-auto mt-2 flex justify-center">
          ...
          <img
            src={mascot}
            alt="Hanuman, the Ouk Chatrang mascot"
            width={1024}
            height={1024}
            className="animate-float relative h-52 w-52 drop-shadow-xl"
          />
        </div>
